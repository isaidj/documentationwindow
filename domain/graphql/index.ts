...
export type FindHelpOrderBy = {
  createDate?: InputMaybe<OrderTypes>;
  description?: InputMaybe<OrderTypes>;
  outlineId?: InputMaybe<OrderTypes>;
  state?: InputMaybe<OrderTypes>;
  url?: InputMaybe<OrderTypes>;
};

export type FindHelpWhere = {
  _and?: InputMaybe<Array<FindHelpWhere>>;
  _or?: InputMaybe<Array<FindHelpWhere>>;
  createDate?: InputMaybe<DateFilter>;
  description?: InputMaybe<StringFilter>;
  outlineId?: InputMaybe<StringFilter>;
...
export type QueryHelpsArgs = {
  orderBy?: InputMaybe<Array<FindHelpOrderBy>>;
  pagination?: InputMaybe<Pagination>;
  where?: InputMaybe<FindHelpWhere>;
};
...
export type HelpsQueryVariables = Exact<{
  where?: InputMaybe<FindHelpWhere>;
}>;


export type HelpsQuery = { __typename?: 'Query', helps: Array<{ __typename?: 'Help', id: number, description: string, url: string, outlineId: string, createDate: any, state: StateHelp }> };
