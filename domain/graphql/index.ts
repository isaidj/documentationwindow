...
export type PagarObligacionesInput = {
  ...
  pagarObligacionesRechazarInput?: InputMaybe<
    Array<PagarObligacionesRecharInput>
  >;
...
export type ResponseDocumentsModel =
  | CdpModel
  | EgresoModel
  | OpModel
  | OprModel
 ...
 * });
 */
export function useHelpsQuery(
  baseOptions?: Apollo.QueryHookOptions<HelpsQuery, HelpsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<HelpsQuery, HelpsQueryVariables>(
    HelpsDocument,
    options
  );
}
export function useHelpsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<HelpsQuery, HelpsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<HelpsQuery, HelpsQueryVariables>(
    HelpsDocument,
    options
  );
}
export function useHelpsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<HelpsQuery, HelpsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<HelpsQuery, HelpsQueryVariables>(
    HelpsDocument,
    options
  );
}
...
export type HelpsSuspenseQueryHookResult = ReturnType<
  typeof useHelpsSuspenseQuery
>;
export type HelpsQueryResult = Apollo.QueryResult<
  HelpsQuery,
  HelpsQueryVariables
>;
